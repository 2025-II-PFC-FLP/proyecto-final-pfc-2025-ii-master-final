...
class GenerarProgramacionRiegoTest extends AnyFunSuite {
  ...
  test("riego de finca con 4 tablones"){
    val tabFinca : Finca = fincaAlAzar(4)
    val progEsperada : Vector[ProgRiego] = Vector(Vector(0, 1, 2, 3), Vector(0, 1, 3, 2), Vector(0, 2, 1, 3), Vector(0, 2, 3, 1), Vector(0, 3, 1, 2), Vector(0, 3, 2, 1),
  ...
  test("riego de finca con 5 tablones"){
